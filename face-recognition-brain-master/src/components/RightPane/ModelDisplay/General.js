    ...
    <div className="rcontent-general dib relative w-100">
        ...
        </div>
        {
            respData.outputs[0].data.concepts.map((item) =>
                <div key={item.id} className="rcontent-general-item db pa2 w-90 center relative tl lh-copy hover-bg-light-gray">
